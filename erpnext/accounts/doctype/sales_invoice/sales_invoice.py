...
from erpnext.zra_client.sales.main import NormaSale, CreditNote, DebitNote
import frappe
import frappe.utils
...
class SalesInvoice(SellingController):
	...
	def on_submit(self):
		...
		if is_return == 1:
			...
			credit_debit_note_obj = DebitNote()
			credit_debit_note_obj.send_debit_sale_data(sell_order)
